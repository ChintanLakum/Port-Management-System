            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="text-center md:text-left">
                    ...
                    <ul className="space-y-2 text-sm text-gray-400">
                        <li>Behind Saurastra University</li>
                        <li>Near Gangotri Park </li>
                        <li>Rajkot Gujarat 360005</li>
                        <li><Link to="" className="hover:text-white transition-colors duration-300">6351415182</Link></li>
                        <li><Link to="" className="hover:text-white transition-colors duration-300">www,chintanlakum16@gmail.com</Link ></li>
                    </ul>
                </div>
                <div className="text-center md:text-left">
