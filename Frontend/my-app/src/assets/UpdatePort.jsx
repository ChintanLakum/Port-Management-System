...
const UpdatePort = () => {
    ...
    const handleConfirmUpdate = async () => {
        ...
        try {
            ...
            const responce = await fetch(`/api/port/updatePort/${portId}`,
                {
                    method: "PUT",
                    headers: {
            ...
            if (responce.ok) {
                if (responce.status === 204) {
                    console.log(`Port ${portId} updated successfully (204 No Content).`);
                } else {
                    const data = await responce.json();
                    console.log(`Port ${portId} updated successfully.`, data);
                }
            }
                ...
                console.error("Failed to update port:", errorData.message || responce.statusText);
            }
        } catch (error) {
            ...
            console.log("Port Update attempt finished.");
        }
    }
