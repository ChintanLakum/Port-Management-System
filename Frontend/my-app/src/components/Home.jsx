...
import TopShips from "../components/TopShip"
import TopPorts from "../components/TopPort";

const Home = () => {
    const imageUrl = "./src/assets/bgimage2.png";
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (isAdmin) {
                        ...
                        setdata(dataToSet.stats);
                        console.log(dataToSet.stats )
                    }
                } else {
